...
var config = {
    ...
    workReleasePackageTemplatePath:function() {return path.join(this.workCopyFilesTemplatePath() ,"release/");},
...
function copyReleaseFrameworkFiles(){
    //var frameworkReleasePath = config.workReleasePackageTemplatePath();
    xtools.copyDirEx(config.workReleasePackageTemplatePath(),config.targetReleasePackagePath());
...
exports.coderDefine = {name:"js-framework",desc:"create a react js framework and related project code"};
